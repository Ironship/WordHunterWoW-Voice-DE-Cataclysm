# QuestWordHunter — German Voiceover: Cataclysm

The German a quest giver says out loud, for Cataclysm: quest ids
**14,621–29,377**.

**35,322 clips, 42.0 hours.** Both are counted from this pack's own duration
...
`sounds/` is committed, and `.gitignore` says why. It is 790 MB here, out of
...
```
python Tools/build_pack.py --only Cataclysm --out "…/Interface/AddOns"
```
